...
import { Plus, Pencil, X, Search, Phone, ChevronDown, UserCheck, UserX } from 'lucide-react'
      ...
      {filteredCarers.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-500 text-sm">
            {carers.length === 0
              ? 'No carers registered yet. Add your first carer to get started.'
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Carer</th>
                  ...
                  <th className="text-right px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider hidden lg:table-cell">Rate</th>
                  <th className="text-center px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider hidden lg:table-cell">This Month</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredCarers.map(carer => {
                  ...
                  return (
                    <tr key={carer.id} className={`transition-colors ${isActive ? 'hover:bg-gray-50' : 'bg-gray-50/50'}`}>
                      {/* Name + Employee ID */}

          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">Postcode</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredClients.map(client => (
                <tr key={client.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600 hidden sm:table-cell">{client.phone || '—'}</td>
                  <td className="px-6 py-4 text-sm text-gray-600 hidden md:table-cell">{client.postcode || '—'}</td>
